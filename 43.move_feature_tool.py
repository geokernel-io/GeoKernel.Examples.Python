...
class MoveFeatureToolWindow(QMainWindow):
    ...
    def create_ui(self) -> None:
        ...
        self.select_action = self.create_action("Select.svg", "Select", self.activate_select, True)
        self.move_action = self.create_action("Move.svg", "Move Feature", self.activate_move, True)
