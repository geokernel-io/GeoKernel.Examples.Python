...
class ScalebarWindow(QMainWindow):
    def __init__(self, app: QApplication) -> None:
        super().__init__()
        self.app = app
        self.viewer = Viewer()
        self.viewer.set_tool(ViewerTool.PAN)
        self.viewer.set_scale_bar_anchor(OverlayAnchor.BOTTOM_RIGHT)
    ...
    def initialize_viewer(self) -> None:
        ...
        try:
            ...
            QMessageBox.critical(self, "Scalebar", f"World layer could not be loaded:\n\n{error}")
...
def main() -> None:
    ...
    app.setApplicationName("Scalebar")
    app.setWindowIcon(app_icon)
    window = ScalebarWindow(app)
    window.show()
