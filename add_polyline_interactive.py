...
class AddPolylineInteractiveWindow(QMainWindow):
    ...
    def create_toolbar(self) -> None:
        ...
        self.add_polyline_action = self.create_action(
            "Polyline.png", "Add Polyline", self.activate_add_polyline, True
        )
        self.pan_action = self.create_action("Pan.png", "Pan", self.activate_pan, True)
        ...
        self.clear_action = self.create_action(
            "Delete.png", "Clear Lines", self.clear_polylines
        )
