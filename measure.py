...
class MeasureWindow(QMainWindow):
    ...
    def create_measure_toolbar(self) -> None:
        ...
        self.distance_action = self.add_tool("MeasureDistance.png", "Distance", self.activate_distance, True)
        self.area_action = self.add_tool("MeasureArea.png", "Area", self.activate_area, True)
