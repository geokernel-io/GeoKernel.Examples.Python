...
class AddPolylineProgrammaticWindow(QMainWindow):
    ...
    def create_toolbar(self) -> None:
        ...
        self.add_action = self.create_action("Polyline.png", "Add Polyline", self.add_next_polyline)
        self.clear_action = self.create_action("Delete.png", "Clear Lines", self.clear_polylines)
