...
class GeoTiffLoadWindow(QMainWindow):
    def __init__(self, app: QApplication) -> None:
        ...
        self.setWindowTitle("GeoTiffLoad")
    ...
    def show_metadata(self, path: Path) -> None:
        ...
        self.statusBar().showMessage(f"GeoTIFF loaded: {path.name}")
...
def main() -> None:
    ...
    app.setApplicationName("GeoTiffLoad")
    app.setWindowIcon(application_icon())
    window = GeoTiffLoadWindow(app)
    window.show()
