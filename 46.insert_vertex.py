...
class InsertVertexWindow(QMainWindow):
    ...
    def create_toolbar(self)->None:
        ...
        self.addToolBar(bar)
        self.pan_action=self.make("Pan.svg","Pan",self.activate_pan,True)
        self.select_action=self.make("Select.svg","Select",self.activate_select,True)
        ...
        self.insert_action=self.make("Add.svg","Insert Vertex",self.insert_vertex)
        self.reset_action=self.make("Refresh.svg","Reset Shape",self.reset_shape)
        self.extent_action=self.make("FullExtent.svg","Full Extent",self.viewer.full_extent)
