...
class EditVerticesToolWindow(QMainWindow):
    ...
    def create_toolbar(self) -> None:
        ...
        self.edit_action = self.action("Edit.png", "Edit Vertices", self.activate_edit, True)
        self.delete_action = self.action("Delete.png", "Delete Vertex", self.delete_vertex)
        self.reset_action = self.action("Refresh.png", "Reset Shapes", self.reset_shapes)
        self.extent_action = self.action("FullExtent.png", "Full Extent", self.viewer.full_extent)
