...
class SnappingEnabledWindow(QMainWindow):
    ...
    def create_toolbar(self) -> None:
        ...
        self.addToolBar(bar)
        self.add_action = self.make("Polyline.svg", "Add Polyline", self.activate_add)
        self.snap_action = self.make(
            "Snapping.svg", "Snapping", self.toggle_snapping, True
        )
        ...
        self.reset_action = self.make("Refresh.svg", "Reset Guide", self.reset)
