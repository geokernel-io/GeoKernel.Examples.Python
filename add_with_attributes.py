...
class AddWithAttributesWindow(QMainWindow):
    ...
    def create_ui(self) -> None:
        ...
        self.add_action = self.create_action("Point.png", "Add Point With Attributes", self.add_point)
        self.info_action = self.create_action("Identify.png", "Info", self.toggle_info, True)
        self.clear_action = self.create_action("Delete.png", "Clear Points", self.clear_points)
